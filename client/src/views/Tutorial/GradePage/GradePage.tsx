...
export default function GradePage() {
  ...
  const handleGradeStandingChange = (
    selectedGradeStanding: SetStateAction<string>
  ) => {
    setGradeStanding(selectedGradeStanding)
  }

  const currName = state.name
  const currEmail = state.email
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        <img
          ...
          alt="Logo"
        />
        <span style={{ fontWeight: 'bold', fontSize: '1.5rem' }}>2</span>
      </Box>
      ...
      >
        ...
        >
          ...
          >
            Grade Standing <span style={{ color: 'red' }}> *</span>
          </Typography>
          <Dropdown onGradeStandingChange={handleGradeStandingChange} />
          <Typography
            color="primary"
            sx={{
              marginTop: '5rem',
          ...
          >
            What is your major? <span style={{ color: 'red' }}> *</span>
          </Typography>
          <TextField
            value={major}
            onChange={(e) => {
